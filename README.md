...
| `wheel-ui` | 慣性と中央への吸い付きを保ち、PC・スマホで使えるホイール型ピッカーを実装します。 |
...
| `minimal-writing` | 文章の意味が一読で伝わるか確認し、伝わらない表現だけ意図を保って直します。 |
...
- [作業結果の報告](rules/作業結果の報告/AGENTS.md): 狙い、実施内容、結果をつなげ、比較条件と結論の範囲を伝えます。
